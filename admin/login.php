...
<body>
	...
	<form action="loginprocess.php" method="POST">
		...
		<div style="color:#7E685A; font-family:'Copperplate', 'Copperplate Gothic Light'">Join the Family!&nbsp; &nbsp; &nbsp;<a href="register.php" style="color: black; font-size:20px;">Sign Up</a></div><br>
